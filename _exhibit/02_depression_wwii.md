...
{% include exhibit/exhibit-image-float.html objectid="parkscentennial5" width="25" float="end" link="https://digital.lib.iastate.edu/exhibits/objects/parkscentennial/pdf/rs025-001-010b1f1.pdf" %}
{% include exhibit/exhibit-image-float.html objectid="parkscentennial1" width="50" %}
...
{% include exhibit/exhibit-image-float.html objectid="parkscentennial4" width="25" float="start" %}
...
{% include exhibit/exhibit-image-float.html objectid="parkscentennial9" width="25" float="end" %}
...
{% include exhibit/exhibit-image.html objectid="parkscentennial30" width="50" %}
